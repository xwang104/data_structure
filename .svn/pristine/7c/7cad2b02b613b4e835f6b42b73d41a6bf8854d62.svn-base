...
/*    List<int> l2;
    ...
    cout << "[testInserts]: " << l2 << endl;
    List<int> l3 = l2.split(2);
    cout << "[testsplit]: " << l2 << endl;
    cout << "[testsplit]: " << l3 << endl;
*/
    cout << "[main]: " << __func__ << "()" << endl;
...
/*    List<int> m2;
    ...
    cout << "[testInserts]: " << m2 << endl;
    cout << "[testInserts]: " << m3 << endl;
    m2.mergeWith(m3);
    cout << "[testsmerge]: " << m2 << endl;
    cout << "[testsmerge]: " << m3 << endl;
*/
    cout << "[main]: " << __func__ << "()" << endl;
