...
class gradientColorPicker : public colorPicker
{
  ...
  private:
     ...
     */
    RGBAPixel color1; /**< Color used to start the gradient. */
    RGBAPixel color2; /**< Color used to end the gradient. */
    int rad; /*radius*/
    int cX; /*X coordinate for the center*/
    int cY; /*Y coordinate for the center*/
};
