...
RGBAPixel gradientColorPicker::operator()(int x, int y)
{
    ...
    if (dis >= rad)
        ...
        color.red = color1.red - int(dis * color1.red / rad) + int(dis * color2.red / rad);
        color.blue = color1.blue - int(dis * color1.blue / rad) + int(dis * color2.blue / rad);
        color.green = color1.green - int(dis * color1.green / rad) + int(dis * color2.green / rad);
    }
    return color;
}
